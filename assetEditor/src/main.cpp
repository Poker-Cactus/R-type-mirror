...
int main(int argc, char *argv[])
{
  ...
  WindowPtr window(SDL_CreateWindow("R-Type Asset Editor", SDL_WINDOWPOS_CENTERED, SDL_WINDOWPOS_CENTERED, 1280, 720,
  ...
  RendererPtr renderer(SDL_CreateRenderer(window.get(), -1, SDL_RENDERER_PRESENTVSYNC | SDL_RENDERER_ACCELERATED));
